...
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerBlockEntity;
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerBlockWithoutTab;
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerItem;
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerPlantBlock;
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerPlantItem;
import static net.hibiscus.naturespirit.registration.NSRegistryHelper.registerTallPlantBlock;
